...
BEGIN
  ...
  FOR v_project IN SELECT id, slug FROM public.projects LOOP
    ...
    IF v_project.slug IN ('sales', 'sales-pipeline') THEN
      ...
      -- Pipeline value (suma open deals)
